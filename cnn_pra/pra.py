...
# 複数画像の読み込み
files_h_d = sorted(glob.glob("/Volumes/Untitled/CNNの練習用画像/上から_遠目の画像/*.jpg"), reverse=False)
files_h_s = sorted(glob.glob("/Volumes/Untitled/CNNの練習用画像/上から_近目の画像/*.jpg"), reverse=False)
files_u_d = sorted(glob.glob("/Volumes/Untitled/CNNの練習用画像/水平_遠目の画像/*.jpg"), reverse=False)
files_u_s = sorted(glob.glob("/Volumes/Untitled/CNNの練習用画像/水平_近目の画像/*.jpg"), reverse=False)
...
def draw_line(file, out_image):
    ...
    im = cv2.imread("/Users/miyazakisora/Python/resize.jpg", 0)
...
for i in range(len(files_h_d)):
    ...
    num += 1
    print(num, "枚目")
    draw_line(files_h_d[i], f"/Volumes/Untitled/CNNの練習用画像/波線水平遠目/horizontal_distant{i+1}.jpg")
num = 0
for i in range(len(files_h_s)):
    ...
    num += 1
    print(num, "枚目")
    draw_line(files_h_s[i], f"/Volumes/Untitled/CNNの練習用画像/波線水平近目/horizontal_short{i+1}.jpg")
num = 0
for i in range(len(files_u_d)):
    ...
    num += 1
    print(num, "枚目")
    draw_line(files_u_d[i], f"/Volumes/Untitled/CNNの練習用画像/波線上から遠目/up_distant{i+1}.jpg")
num = 0
for i in range(len(files_u_s)):
    ...
    num += 1
    print(num, "枚目")
    draw_line(files_u_s[i], f"/Volumes/Untitled/CNNの練習用画像/波線上から近目/up_short{i+1}.jpg")        