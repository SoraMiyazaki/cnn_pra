...
data_hd = data_hd[1000:1300]
data_hs = data_hs[1000:1300]
data_ud = data_ud[1000:1300]
data_us = data_us[1000:1300]
...
# dataset
file_hd = sorted(glob.glob("data/poc/image/test50/hd/*.jpg"), key=natural_keys)
file_hs = sorted(glob.glob("data/poc/image/test50/hs/*.jpg"), key=natural_keys)
file_ud = sorted(glob.glob("data/poc/image/test50/ud/*.jpg"), key=natural_keys)
file_us = sorted(glob.glob("data/poc/image/test50/us/*.jpg"), key=natural_keys)
...
np.savetxt("test50.csv", ds, delimiter=',', fmt="%s")